...
#
plotter(x=x/AU,data=A_FR,data2=A_DR,times=TI/year,xlog=1,ylog=1,xlim=[0.5,500],xlabel='r [AU]',i_start=0,ylabel='grain size [cm]')
#
# evolution of the surface density
#
plotter(x=x/AU,data=SOL,times=TI/year,xlog=1,ylog=1,xlim=[0.5,500],xlabel='r [AU]',i_start=0,ylabel='$\Sigma_d$ [g cm $^{-2}$]')	
#
# export the data
#
dirname = 'data'
