...
\rhead{Juan Carlos Torres Fellowship Research Proposal}
\date{}
%\rhead{\thepage}
...
\title{\Large Juan Carlos Torres Fellowship Research Proposal \\
...
\textbf{The Massachusetts Institute of Technology (MIT) is the best place for me to pursue my postdoctoral research}, due to its vibrant community of experts in exoplanet atmospheres and dynamics, both in the Physics and Earth, Atmospheric and Planetary Sciences (EAPS) departments. In particular, I would like to collaborate with \textbf{Prof. Sara Seager}, who is a co-investigator of the \textbf{TESS mission} and a world-leading theorist in atmospheric chemistry, as well as with members of her group, who specialize in a broad range of exoplanet theory and computational topics. I would also love to work with \textbf{Prof. Hilke Schlichting}, a leader in planet formation theory and dynamics. \textbf{Dr. Margaret Pan}, an excellent theorist in planetary dynamics and protoplanetary disks, will join the EAPS department as a research scientist in early 2016, so it would be a pleasure to work with her as well. Finally, in order to connect my theoretical work with observations, I would like to collaborate with \textbf{Prof. Joshua Winn}, who is an expert in discovering and characterizing exoplanets. \\
