...
\item[] Thesis Topic: ``The Role of Disk Volatile Chemistry and Dynamics in Shaping the Compositions of Nascent Planets''
\end{list1}
{\bf Harvard University}, Cambridge, MA \\
\begin{list1}
\vspace{-0.1in}
...
\begin{list1}
%\vspace{-0.1in}
\item[] Viena University of Technology (TU Wien) \hfill \textit{Vienna, Austria}
