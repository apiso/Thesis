...
\begin{list1}
\vspace{-0.1in}
\item[] Ph.D., Astronomy \& Astrophysics, May 2016
...
\item[] {\bf Postdoctoral Fellow} \hfill {\bf September 2016 - }
%{\bf Harvard-Smithsonian Center for Astrophysics} \hfill \textit{Cambridge, MA}
\begin{list1}
%\vspace{-0.1in}
\item[] UCLA, Earth, Planetary and Space Sciences Department \hfill \textit{Los Angeles, CA}
...
\begin{list2}
\item[] {\bf Piso, A.-M. A.}, Pegues, J., \& \"Oberg, K.I. \textit{The Role of Ice Compositions and Morphology For Snowlines and the C/N/O Ratios in Active Disks}. ApJ, submitted \\
\end{list2}
