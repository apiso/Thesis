...
\rhead{Hubble Fellowship Research Proposal}
\date{}
%\rhead{\thepage}
...
\title{Hubble Fellowship Research Statement: \\
...
%\vspace{-0.5in}
\caption{ALMA continuum image of the disk around HL Tau, which shows evidence of a gas gap in the disk, most likely created due to planetary migration (from $[1]$).}
\label{fig:HLTau}
\end{figure}
...
$[10]$ Piso, A.-M. A., Öberg, K.I., Birnstiel, T, \& Murray-Clay, R.M., ApJ, resubmitted after referee report \\
