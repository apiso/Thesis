...
How Unique is the Solar System? Planetary Luminosities as Fingerprints for the Origins and Properties of Exoplanets}
...
%\vspace{-0.5in}
\caption{Same as above, but planets detected via gravitational microlensing (green) and direct imaging (yellow) are added. Besides the terrestrial planets, Jupiter, Saturn, Uranus and Neptune are also shown. There is a scarcity in Super Earth detections at wide separateions.}
\label{fig:chemical}
\end{figure}
...
%\vspace{-0.5in}
\caption{Example of a planet's luminosity and time evolution with atmospheric mass, during the giant planet formation stage. From [6].}  %The actual magnitude of dust opacities is difficult to robustly predict.}
