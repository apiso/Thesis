...
\begin{figure*}[h!]
\centering
\includegraphics[width=0.8\textwidth]{../../figs/desorption_distance_actual_vs_estimated_passive_active.pdf}
%\vspace{-0.5in}
