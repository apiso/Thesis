...
\begin{figure*}[tb]
\centering
\includegraphics[width=\textwidth]{../../figs/desorption_distance_passive_active_colorbar.pdf}
%\vspace{-0.5in}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.5\textwidth]{../../figs/C_O_ratio_passive_active_disk_many_colorbar.pdf}
%\vspace{-0.5in}
