...
We determine the location of the H$_2$O, CO$_2$, CO and CH$_4$ snowlines in our static disk by balancing desorption with readsorption, following \citet{hollenbach09}. The binding energies of H$_2$O, CO$_2$, CO and CH$_4$ as pure ices are 5800 K, 2000 K, 1388 K and 1300 K, respectively (\citealt{fraser01}, \citealt{collings04}, Fayolle et al., submittted, \citealt{garrod06}).
...
As noted in Section \ref{sec:intro}, the CO binding energy varies significantly depending on the environment in which the icy grains reside. If CO ice is layered on top of a water ice substrate, its binding energy will be larger than in the pure ice case (1388 K) due to the higher H$_2$O binding energy. Fayolle et al. (submitted) find a CO binding energy of 834 K in the layered ice scenario. We use the model of Section \ref{sec:review} to estimate the movement of the CO snowline for different grain morphologies in a viscous disk.
...
In addition to carbon and oxygen, nitrogen is 
