...
\noindent The contents of this chapter have been submitted for publication in \textit{Piso, A.-M. A., Pegues, J., \& \"Oberg, K.I. 2016, ApJ, submitted}
...
In this work, we expand the coupled drift-desorption model developed in (\citealt{piso15b}; hereafter Paper I) by considering additional volatile molecules and abundances, ice morphology, as well as nitrogen-to-oxygen (N/O) ratios. This paper is organized as follows. In Section \ref{1sec:review}, we review the drift-desorption model developed in Paper I. We discuss the effect of different abundances of the main carbon, oxygen and nitrogen carriers, grain morphology and disk dynamics on snowline locations and the C/N/O ratios in Section \ref{1sec:results}. We address the implications of our results in Section \ref{1sec:discussion} and summarize our findings in Section \ref{1sec:summary}.  
...
We begin with a brief review of Paper I's model for the effect of radial drift and viscous gas accretion on volatile snowline locations. We review our disk model in Section \ref{1sec:disktime}, and summarize our numerical method and results in Section \ref{1sec:driftdes}.
...
\begin{subeqnarray}
\label{1eq:ddt}
\frac{ds}{dt} &= & - \frac{3 \mu_x m_{\rm p}}{\rho_{\rm s}} N_x R_{\rm des, x}  \slabel{1eq:dsdt} \\
\frac{dr}{dt} &=& \dot{r} \slabel{1eq:drdt},
\end{subeqnarray}
...
R_{\rm{des}, x} = \nu_x \exp{(-E_x/T_{\rm grain})},
\end{equation}
where $E_x$ is the adsorption binding energy in units of Kelvin, $T_{\rm grain}=T$ is the grain temperature (assumed to be the same as the disk temperature, see Paper I), and $\nu_x=1.6 \times 10^{11} \sqrt{(E_x/\mu_x)}$ s$^{-1}$ is the molecule's vibrational frequency in the surface potential well. We discuss our choices for $E_x$ for the different volatile species in Section \ref{1sec:snowlines}.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{figures/CNO_and_snowlines_2.pdf}
%\vspace{-0.5in}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{figures/C_O_ratio_CH4.pdf}
%\vspace{-0.5in}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{figures/N_O_ratio.pdf}
%\vspace{-0.5in}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth]{figures/C_O_water_ice.pdf}
%\vspace{-0.5in}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth]{figures/N_O_water_ice_many.pdf}
%\vspace{-0.5in}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{figures/CN_norm.pdf}
%\vspace{-0.5in}
